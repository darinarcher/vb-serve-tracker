...
**Acceptance Criteria:**
- [ ] "New Set" button creates a fresh set
...
**Acceptance Criteria:**
- [ ] "New Match" button creates a fresh match
- [ ] Match identified by ID and date
...
- [ ] Data loaded automatically on page load
...
- [ ] App icon defined (SVG with volleyball emoji)

...
**App Version**: v2 (turns within sets)
...
| Set | New Set creates fresh set | [ ] |
| Set | Clear Set resets current set | [ ] |
| Match | New Match creates fresh match | [ ] |
...
### TC-1.5: Record Serves While Viewing Old Turn
...
**Expected**:
- Serve records to the viewed turn (turn 1)
- Count for turn 1 updates
- Remains viewing turn 1

**Verify**:
- [ ] Serve goes to correct turn
- [ ] Turn navigation indicator stays on viewed turn
...
### TC-2.6: Turn Navigation - Return to Latest
